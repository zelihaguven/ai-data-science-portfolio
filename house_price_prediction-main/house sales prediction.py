...
# Train ve Test veri setlerini okutup birleştirmelisin!
...
# Rare analizi yapınız ve rare encoder uygula
...
# yeni değişkenler oluştur ve oluşturduğun yeni değişkenlerin başına 'NEW' ekle !!
...
# BONUS : Log dönüşümü yaparak model kur ve rmse sonuçlarını gözlemle.
# Not: Log'un tersini (inverse) al !
...
# hiperparametre optimizasyonlarını gerçekleştiriyorum.
...
# Değişkenlerin önem düzeyini belirten feature_importance fonksiyonunu kullanarak özelliklerin sıralamasını çizdiriyorum.
